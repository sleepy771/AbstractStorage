...
public class ExtendedStorageObservable<T> implements StorageObservable<T> {
	...
	public ExtendedStorageObservable(StorageObservable<T> observable,
			Collection<StorageListener<T>> listenerCollection) {
	...
	@Override
	public synchronized final void addAllListeners(
			Collection<StorageListener<T>> listeners) {
	...
	@Override
	public synchronized final void removeAllListenres(
			Collection<StorageListener<T>> listeners) {
