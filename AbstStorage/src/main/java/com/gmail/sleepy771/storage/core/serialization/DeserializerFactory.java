...
public class DeserializerFactory {
    ...
    public void registrateDeserializer(Class<?> objectClass, Class<Deserializer> deserializerClass) {
    ...
    public Deserializer getDeserializer(Class<?> objectClass) throws DeserializerNotFoundException, InstantiationException, IllegalAccessException {
