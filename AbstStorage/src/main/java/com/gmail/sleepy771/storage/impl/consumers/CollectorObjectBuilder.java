...
public class CollectorObjectBuilder<T> implements Buildable<T>, StorageListener<Exception> {
    ...
    public CollectorObjectBuilder(Collector<?> collector, Buildable<T> builder, boolean needAll) {
    ...
    @Override
    public void onNotificationPerform(StorageObservable<Exception> obs, Exception exception) {
	collectorObjectBuilderLock.lock();
	try {
